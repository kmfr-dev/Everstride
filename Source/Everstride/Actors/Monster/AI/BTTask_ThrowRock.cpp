...
#include "BTTask_ThrowRock.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "../../CharacterBase.h"
#include "../../../Component/SkillComponent.h"
#include "../../../Skill/ThrowRockSkill.h"
#include "AIController.h"
#include "AIDefine.h"

EBTNodeResult::Type UBTTask_ThrowRock::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	FSkillMappingData* SkillMappingData = BossPawn->GetSkillMappingData(EverstrideGamePlayTags::TAG_Skill_BossMonster_ThrowRock);
